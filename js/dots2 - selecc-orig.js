...
var colores = ["yellow", "red", "green", "purple", "blue"];
var puntoNumero = 0;
var movimientos = 30;
...
function aplicarPoder3()
{
	barredores--;
	movimientos--;
	
	
	document.getElementById('boton-poder3').style.backgroundColor = '#95D195';
	document.getElementById('mov').innerHTML = movimientos;
	document.getElementById('pod3').innerHTML = barredores;
	barredor = true;
